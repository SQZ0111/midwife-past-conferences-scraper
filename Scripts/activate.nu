...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Programmierung\ML\cousera\webscraper-midwifeToday'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Programmierung\ML\cousera\webscraper-midwifeToday\Scripts\deactivate.nu'
